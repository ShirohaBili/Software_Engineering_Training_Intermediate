...
public class DashBoardController {
    ...
    @RequestMapping(value = "/dashboard/policy")
    public String toPolicy(){ return "policy";}

    @RequestMapping(value = "/dashboard/Area")
    public String toArea(){ return "area";}

    @RequestMapping(value = "/noFound")
    public String toNoFound(){return "NoFound";}
}
