...
public abstract class Jigsaw {
     ...
     */
    public abstract boolean BFSearch(JigsawNode bNode, JigsawNode eNode) throws IOException;
     ...
     */
    public final boolean ASearch(JigsawNode bNode, JigsawNode eNode) throws IOException {
        beginJNode = bNode;
        endJNode = eNode;
